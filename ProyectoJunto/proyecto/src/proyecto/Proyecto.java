...
public class Proyecto {
    ...
    private static modelo.Parte parte;
...
//    }
    ...
    public static modelo.Parte getParte() {
        return parte;
    }

    public static void setParte(modelo.Parte parte) {
    ...
    public static void rellenarViaje(int albaran, String horaSalida, String horaLlegada, String matricula,int parte)
    {
        try {
            ...
            v = new Viaje(albaran,horaSalida,horaLlegada,matricula);
