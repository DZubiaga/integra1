...
public class Principal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        crearParte.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                crearParteActionPerformed(evt);
            }
        });
        jMenu7.add(crearParte);

        modificarAbierto.setText("Modificar abiertos");
        modificarAbierto.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                modificarAbiertoActionPerformed(evt);
            }
        });
    ...
    private void crearParteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_crearParteActionPerformed
    
        Proyecto.ventanaPartes();
        
    }//GEN-LAST:event_crearParteActionPerformed

    private void modificarAbiertoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_modificarAbiertoActionPerformed
        Proyecto.modificarPartesAbiertos();
    }//GEN-LAST:event_modificarAbiertoActionPerformed
