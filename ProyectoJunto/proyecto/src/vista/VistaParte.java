...
public class VistaParte extends javax.swing.JFrame {
    ...
    */
    ...
    public void preguntaFinal()
    {
        ...
        if (tfAlbaran1.getText()!= null)
            {
              Proyecto.rellenarViaje(Integer.parseInt(tfAlbaran1.getText()), hora1(), hora2(), vehiculo1.getSelectedItem().toString(),Proyecto.getAp().getIdParte());
            }
        else if (tfAlbaran2.getText()!= null)
            {
              Proyecto.rellenarViaje(Integer.parseInt(tfAlbaran2.getText()), hora3(), hora4(), vehiculo2.getSelectedItem().toString(),Proyecto.getAp().getIdParte());
            }
        else if (tfAlbaran3.getText()!= null)
            {
              Proyecto.rellenarViaje(Integer.parseInt(tfAlbaran3.getText()), hora5(), hora6(), vehiculo3.getSelectedItem().toString(),Proyecto.getAp().getIdParte());
            }
        else if (tfAlbaran4.getText()!= null)
            {
              Proyecto.rellenarViaje(Integer.parseInt(tfAlbaran4.getText()), hora7(), hora8(), vehiculo4.getSelectedItem().toString(),Proyecto.getAp().getIdParte());
            }
        else if (tfAlbaran5.getText()!= null)
            {
              Proyecto.rellenarViaje(Integer.parseInt(tfAlbaran5.getText()), hora9(), hora10(), vehiculo5.getSelectedItem().toString(),Proyecto.getAp().getIdParte());
            }
